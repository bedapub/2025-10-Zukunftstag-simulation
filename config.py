...
DEV_MODE = False
DEV_BYPASS_QR = False
DEV_AUTO_LOGIN_TEAM = None
DEV_GENERATE_TEST_DATA = False

# Admin authentication for dev
...
COLOR_MEDICINE = COLOR_PURPLE_1
COLOR_SUCCESS = COLOR_PRIMARY_BLUE
COLOR_WARNING = COLOR_ORANGE_1
...
PURPLE_BASE = COLOR_PURPLE_1

# Medal colors (darker versions)
GOLD = '#B8860B'
SILVER = '#696969'
BRONZE = '#654321'
